...
void token::snapshot(account_name contract, asset max_supply, double cw, asset max_exchange, asset supply,
    asset reserve_supply, asset connector_balance, asset reserve_connector_balance, account_name connector_balance_issuer)
{
    require_auth(_self);
}
