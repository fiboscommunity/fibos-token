...
describe(`uniswap addreserves and outreserves`, () => {
    ...
    it(`(error, add): can't bind bancor pair`, () => {
        ctx.exchangeSync(name, `1.0000 FO@eosio`, `0.0000 ${symbol}@${name}`, 0, name, `exchange`, {
            authorization: name
        })
        assert.throws(() => {
            ctx.addreservesSync(name, `10.0000 FORK@user1`, "10.0000 FO@eosio", {
                authorization: name
            });
        });
    });
    ...
    it(`(pass, out): outreserves 100%`, () => {
        ...
        checkunswapmarket(fibos, "FO@eosio", "EOS@eosio", {
            "primary": 0,
            "tokenx": {
                "quantity": "12239.1301 EOS",
                "contract": "eosio"
            },
            "tokeny": {
                "quantity": "119.6306 FO",
                "contract": "eosio"
            },
    ...
    it(`(pass, out): outreserves 45%`, () => {
        ...
        checkaccount(fibos, "fibos", "EOS", "eosio", {
            "quantity": "9963302.1009 EOS",
            "contract": "eosio"
        });
        checkaccount(fibos, "fibos", "FO", "eosio", {
            "quantity": "979933.7799 FO",
            "contract": "eosio"
        });
    })
